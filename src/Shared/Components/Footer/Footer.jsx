                ...
                <div className="row m-auto" style={{ width: '60%' }}>
                    ...
                    <div className="col-md-12 justify-content-center d-md-flex">
                        <div className='text-center'>
                            ...
                            <div className={`${styles['footer-list']} d-flex justify-content-center align-items-center`}>
                                ...
                                <a role={'button'} rel="noreferrer" href="https://www.linkedin.com/in/jaivinmovaliya" target={'_blank'}>
                                     <svg xmlns="http://www.w3.org/2000/svg" width="90" height="90" fill="blue" className="bi bi-linkedin" viewBox="0 0 16 16">
